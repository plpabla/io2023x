 ...
 <!--   <script src="https://code.jquery.com/jquery-3.5.1.js"></script> -->
    ...
    <script>
        $(document).ready(function() {
            // Obsługa zdarzenia wpisywania w polu tekstowym
            $('#search').on('input', function() {
                var search = $(this).val();
                
                // Wywołanie zapytania AJAX do pliku search.php
                $.ajax({
                    url: 'search.php',
                    type: 'GET',
                    data: {search: search},
                    ...
                    success: function(data) {
                        ...
                        // Dodanie nowych sugestii do listy
                        data.forEach(function(item) {
                            $('#suggestions').append('<li>' + item.choroba + '</li>');
                        });
                    }
                });
            });
...
-->
    ...
    ?>
      ...
      <div class="container">
        ...
        <input type="text" id="search" placeholder="Wyszukaj chorobę">
